  ...
  useEffect(() => {
    ...
    Axios.get(
      ...
      .then((response) => {
        ...
        setClientLastName(response.data.patient.lastName);
        setClientContactNo(response.data.patient.contactNo);
        setClientEmail(response.data.patient.email);
        setClientUsername(response.data.patient.username);
        setClientPass(response.data.patient.password);
